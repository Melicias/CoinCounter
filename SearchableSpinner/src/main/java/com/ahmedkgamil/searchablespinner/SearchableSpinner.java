package com.ahmedkgamil.searchablespinner;
...
public class SearchableSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
    ...
    public void setOnItemChangedListener(SearchableListDialog.OnItemChanged onItemChanged){
        _searchableListDialog.setOnItemChangedListener(onItemChanged);
    }
